...
#ifndef CaseInsensitiveStream_h
#define CaseInsensitiveStream_h
...
namespace antlr4 {
    ...
    class CaseInsensitiveStream : public CharStream {
    protected:
    ...
    public:
        ...
        CaseInsensitiveStream(const std::string &input = "");
        CaseInsensitiveStream(const char data_[], size_t numberOfActualCharsInArray);
        CaseInsensitiveStream(std::istream &stream);
