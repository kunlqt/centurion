...
queryTerm
    ...
    | left=queryTerm oper=INTERSECT setQuantifier? right=queryTerm         #setOperation
    | left=queryTerm oper=(UNION | EXCEPT) setQuantifier? right=queryTerm  #setOperation
    ;
...
booleanExpression
    ...
    | left=booleanExpression oper=AND right=booleanExpression  #logicalBinary
    | left=booleanExpression oper=OR right=booleanExpression   #logicalBinary
    ;
...
predicate[antlr4::ParserRuleContext* value]
    ...
    | IS NOT? NULL_VALUE                                                        #nullPredicate
...
valueExpression
    ...
    | oper=(MINUS | PLUS) valueExpression                                           #arithmeticUnary
    | left=valueExpression oper=(ASTERISK | SLASH | PERCENT) right=valueExpression  #arithmeticBinary
    | left=valueExpression oper=(PLUS | MINUS) right=valueExpression                #arithmeticBinary
