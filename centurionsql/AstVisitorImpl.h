...
namespace centurion {
	class AstVisitorImpl : AstVisitor {

	public:
		virtual ~AstVisitorImpl()
		{

		}

		virtual antlrcpp::Any process(Node* node) override;
		virtual antlrcpp::Any process(Node* node, antlr4::ParserRuleContext* context) override;

	private:
		virtual antlrcpp::Any visitExpression(Expression* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitSelect(Select* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitSelectItem(SelectItem* node, antlr4::ParserRuleContext* context) override;
		...
		virtual antlrcpp::Any visitIdentifier(Identifier* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitTable(Table* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitQueryBody(QueryBody* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitRelation(Relation* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitNode(Node* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitDereferenceExpression(DereferenceExpression* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitStatement(Statement* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitQuery(Query* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitWithQuery(WithQuery* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitWith(With* node, antlr4::ParserRuleContext* context) override;
		...
		virtual antlrcpp::Any visitGroupingElement(GroupingElement* node, antlr4::ParserRuleContext* context) override;
		...
		virtual antlrcpp::Any visitComparisonExpression(ComparisonExpression* node, antlr4::ParserRuleContext* context) override;

		virtual antlrcpp::Any visitLiteral(Literal* node, antlr4::ParserRuleContext* context) override;
		...
		virtual antlrcpp::Any visitShowStats(ShowStats* node, antlr4::ParserRuleContext* context) override;
		...
		{
			return visitExpression(node, context) override;
		}
		...
		{
			return visitStatement(node, context) override;
		}
		...
		{
			return visitLiteral(node, context) override;
		}
		...
		{
			return visitRelation(node, context) override;
		}
		...
		{
			return visitTableElement(node, context) override;
		}
		...
		{
			return visitTransactionMode(node, context) override;
		}
		...
		{
			return visitGroupingElement(node, context) override;
		}
