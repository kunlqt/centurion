...
class AstVisitor {
	...
	friend SortItem;
	friend Select;
	friend GroupingElement;
	friend QuerySpecification;
	friend GroupBy;
	friend Join;
	friend Literal;
	friend LogicalBinaryExpression;
	friend ComparisonExpression;
	friend LongLiteral;
	friend DecimalLiteral;
	friend DoubleLiteral;
	friend StringLiteral;
	friend AliasedRelation;
	friend NotExpression;
	friend GroupingOperation;
	friend IsNotNullPredicate;
	friend IsNullPredicate;
	friend SimpleGroupBy;
	friend ArithmeticBinaryExpression;
	friend ArithmeticUnaryExpression;
	friend SubqueryExpression;
	friend ShowStats;
	friend InListExpression;
	friend InPredicate;
