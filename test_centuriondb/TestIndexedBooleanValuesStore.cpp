...
namespace {
	...
	TEST_F(TestIndexedBooleanValueStore, FindSingleDocumentContainingBoolean) {
		...
		auto searchIterator = BooleanValueSearchIterator::eq(*valueIndexStore_, fieldIndexId, indexedValue);
	...
	TEST_F(TestIndexedBooleanValueStore, FindSingleDocumentContainingBooleanWithinMultipleBooleans) {
		...
		auto searchIterator = BooleanValueSearchIterator::eq(*valueIndexStore_, fieldIndexId, indexedValue2);
