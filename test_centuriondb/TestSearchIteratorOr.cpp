...
namespace {
	...
	class TestSearchIteratorOr : public ::testing::Test {
	public:
		TestSearchIteratorOr() : valueIndexStore_(nullptr) {}
	...
	TEST_F(TestSearchIteratorOr, TestMultipleLeftEqualsMultipleRight) {
		...
		SearchIterator* searchIterator = new SearchIteratorOr(
